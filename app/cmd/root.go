...
func addCommonLintAndInstallFlags(flags *pflag.FlagSet) {
	...
	flags.StringSlice("chart-repo-credentials", []string{}, heredoc.Doc(`
		Credentials for added chart repos. May be specified multiple times or
...
func bindRootFlags(flagSet *flag.FlagSet, v *viper.Viper) error {
	options := []string{"remote", "target-branch", "all", "charts", "chart-dirs", "chart-repos", "chart-repo-credentials", "excluded-charts", "debug"}
