...
func loadAndAssertConfigFromFile(t *testing.T, configFile string) {
	...
	require.Equal(t, []string{"incubator=https://incubator", "private=https://private"}, cfg.ChartRepos)
	require.Equal(t, []string{"private=user:pass"}, cfg.ChartRepoCredentials)
